...
(commtnt
#(let [t  [(%1 %2 %3) (%1 %3 %2)]]
            (cond (= t [false true]) :gt
                  (= t [false false]) :eq
                  (= t [true false]) :lt)
            )

(#(if-let [t [(%1 %2 %3) (%1 %3 %2)]] ) < 5 1)

(#(if (%1 %2 %3) :lt (if (%1 %3 %2) :gt :eq)) < 5 1)

(let [__ #(if (%1 %2 %3) :lt (if (%1 %3 %2) :gt :eq))]
  #_(every? true?)
  [(= :gt (__ < 5 1))
...
(#(vector (%1 %2 %3) (%1 %3 %2)) < 5 1)
(#(vector (%1 %2 %3) (%1 %3 %2)) (fn [x y] (< (count x) (count y))) "pear" "plum")
(#(vector (%1 %2 %3) (%1 %3 %2)) (fn [x y] (< (mod x 5) (mod y 5))) 21 3)
(#(vector (%1 %2 %3) (%1 %3 %2)) > 0 2)
